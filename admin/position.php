...
if(isset($_POST['delete'])){
  ...
  $deleteposition = "DELETE FROM `position` WHERE `position_id`=$position_id";
  $delete = $dbconnect->query($deleteposition);
  if($delete){
...
if(isset($_POST['submit'])){
  $pname = $_POST['pname'];
  $status = $_POST['status'];
  $addposition = "INSERT INTO `position`(`position_name`, `position_status`) VALUES ('$pname', '$status')";
  $result = $dbconnect->query($addposition);
  if($result){
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Position Status</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          <div>
                            <p class="font-semibold"><?php echo $position['position_name'];?></p>
                          </div>
                        </div>
                      </td>
                      <td class="px-4 py-3 text-xs">
                        <?php echo ($position['position_status'] == 1 ? "ACTIVE": "NOT ACTIVE");?>
                      </td>
                      <td class="px-4 py-3">
