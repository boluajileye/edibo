...
if(!isset($_SESSION['user_id'])){
  $user_id = $_SESSION['user_id'];
    header("Location: admin/index.php");
          ...
          $user_id = $_SESSION['user_id'];
           $checkvoted = "SELECT `user_id` FROM election WHERE `user_id` = $user_id";
           $result = $dbconnect->query($checkvoted);
           if(!$result){
                ...
                <div class="flex items-center text-sm">
                  ...
                  >
                    <img
                      ...
                      src="./admin/includes/assets/img/<?php echo $candidate['candidate_image'];?>"
                    ...
                    ></div>
                      ...
                      <td class="px-4 py-3 text-xs">
                        <span
                          class="px-2 py-1 font-semibold dark:bg-gray-700 dark:text-gray-200"
                        >
